# Explicit Git aliases/functions previously loaded through `zinit snippet OMZP::git`.
# Source this file directly instead of loading the alias-only Oh My Zsh plugin.
# Based on ohmyzsh/plugins/git/git.plugin.zsh at 677a459.
