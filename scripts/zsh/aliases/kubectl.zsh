# Explicit kubectl aliases/functions previously loaded through `zinit snippet OMZP::kubectl`.
# Completion is loaded once from .zshrc with `kubectl completion zsh`.
# Based on ohmyzsh/plugins/kubectl/kubectl.plugin.zsh at 677a459.
