# Explicit kubectl aliases/functions copied from Oh My Zsh's kubectl plugin.
# Completion setup intentionally lives in ~/.zshrc as direct `kubectl completion zsh`
# sourcing, so this file does not create or cache completion files.
